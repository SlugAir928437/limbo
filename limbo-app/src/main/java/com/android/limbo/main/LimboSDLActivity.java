...
import com.android.limbo.keymapper.KeyMapManager;
...
import com.android.limbo.screen.ScreenUtils;
...
public class LimboSDLActivity extends SDLActivity
    ...
    public void onBackPressed() {
        if (mKeyMapManager != null && mKeyMapManager.isEditMode()) {
            ...
            // No persistent toolbar: the back button brings up the VM action
            // menu (the original toolbar's items) instead of the ActionBar.
            showRuntimeMenu();
        } else {
            KeyboardUtils.hideKeyboard(this, mSurface);
            finish();
