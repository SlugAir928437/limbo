...
public enum MachineProperty {
    ...
    ARCH, MACHINETYPE, CPU, CPUNUM, MEMORY, DISABLE_I8042, ENABLE_MTTCG, ENABLE_KVM,
    ENABLE_NVRAM, NVRAM_PATH,
    ...
    HDA_FORMAT, HDB_FORMAT, HDC_FORMAT, HDD_FORMAT, CDROM_FORMAT,
    HDA_CACHE, HDB_CACHE, HDC_CACHE, HDD_CACHE,
    BOOT_CONFIG, KERNEL, INITRD, APPEND, BIOS,
