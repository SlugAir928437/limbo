...
import com.android.limbo.files.FileInstaller;
import com.android.limbo.files.FileUtils;
import com.android.limbo.install.Installer;
import com.android.limbo.keyboard.KeyboardUtils;
import com.android.limbo.log.Logger;
import com.android.limbo.machine.ArchDefinitions;
import com.android.limbo.machine.BIOSImporter;
...
import com.android.limbo.machine.MachineController.MachineStatus;
import com.android.limbo.machine.MachineExporter;
import com.android.limbo.machine.MachineFilePaths;
import com.android.limbo.machine.MachineImporter;
import com.android.limbo.machine.MachineProperty;
import com.android.limbo.network.NetworkUtils;
import com.android.limbo.toast.ToastUtils;
import com.android.limbo.ui.LimboComposeBridge;
import com.android.limbo.ui.LimboUiCallbacks;
import com.android.limbo.ui.LimboUiState;
import com.android.limbo.ui.StorageDeviceEditorActivity;
import com.android.limbo.ui.StorageDeviceUiState;
import com.android.limbo.updates.UpdateChecker;
...
public class LimboActivity extends AppCompatActivity implements
    ...
    public void onEnableMTTCGChanged(boolean checked) {
        if (getMachine() == null)
            return;
        // update the Compose state immediately so the switch reflects the new
        // value in real time (persistence happens via notifyFieldChange/Dispatcher)
